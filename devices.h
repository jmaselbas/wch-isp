...
const struct db devices[] = {
	...
	{ .type = 0x16, .flash_sector_size = 1024,
	  .name = "CH58x",
	  .devs = (const struct db_dev[]){
		{ 0x81, "CH581", SZ_192K, SZ_32K },
		{ 0x82, "CH582", SZ_448K, SZ_32K },
		{ 0x83, "CH583", SZ_448K, SZ_512K },
		{ /* sentinel */ } }
	},
	{ .type = 0x17, .flash_sector_size = 4096,
	  .name = "CH32V30x",
	  .devs = (const struct db_dev[]){
		{ 0x30, "CH32V303VCT6", SZ_480K },
		{ 0x31, "CH32V303RCT6", SZ_480K },
		{ 0x32, "CH32V303RBT6", SZ_480K },
		{ 0x33, "CH32V303CBT6", SZ_480K },
		{ 0x50, "CH32V305RBT6", SZ_480K },
		{ 0x70, "CH32V307VCT6", SZ_480K },
		{ 0x71, "CH32V307RCT6", SZ_480K },
		{ 0x73, "CH32V307WCU6", SZ_480K },
		{ /* sentinel */ } }
	},
	{ .type = 0x18, .flash_sector_size = 4096,
	  .name = "CH32F20x",
	  .devs = (const struct db_dev[]){
		{ 0x30, "CH32F203VCT6", SZ_224K },
		{ 0x31, "CH32F203RCT6", SZ_224K },
		{ 0x33, "CH32F203CBT6", SZ_224K },
		{ 0x50, "CH32F205RBT6", SZ_480K },
		{ 0x70, "CH32F207VCT6", SZ_480K },
		{ 0x80, "CH32F208WBU6", SZ_480K },
		{ 0x81, "CH32F208RBT6", SZ_480K },
		{ /* sentinel */ } }
	},
	{ .type = 0x19, .flash_sector_size = 4096,
	  ...
	  .devs = (const struct db_dev[]){
		...
		{ 0x81, "CH32V208RBT6", SZ_480K },
		{ 0x82, "CH32V208CBU6", SZ_480K },
		{ 0x83, "CH32V208GBU6", SZ_480K },
		{ 0x30, "CH32V203C8U6", SZ_224K },
		{ 0x31, "CH32V203C8T6", SZ_224K },
		{ 0x32, "CH32V203K8T6", SZ_224K },
		{ 0x33, "CH32V203C6T6", SZ_224K },
		{ 0x34, "CH32V203RBT6", SZ_224K },
		{ 0x35, "CH32V203K6T6", SZ_224K },
		{ 0x35, "CH32V203G6U6", SZ_224K },
		{ 0x35, "CH32V203F6P6", SZ_224K },
		{ 0x37, "CH32V203F6P6", SZ_224K },
		{ /* sentinel */ } }
	},
};
